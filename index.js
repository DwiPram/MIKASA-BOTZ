/*
]=====> DWI XYZ <=====[ ]=====> IG @dwipram___ <=====[ ]=====> 085753213819 <=====[
*/
const {
   WAConnection,
   MessageType,
...
// JAN NGEYEL AJG
            + 'ORG:OWNER BOTZ;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6285753213819:+62 857-5321-3819\n' 
            + 'END:VCARD' 
prefix = '!'
blocked = []   
limitawal = 20
memberlimit = 2
cr = '*ELDER 𝐁𝐎𝐓𝐙 𝐕𝐄𝐑𝐈𝐅𝐈𝐄𝐃*'

/*
]=====> SETTINGS <=====[
*/
const ownerNumber = ["6285753213819@s.whatsapp.net","6285753213819@s.whatsapp.net"]
const botName = 'ELDER 𝐁𝐎𝐓𝐙'
const ownerName = 'Dwi XyZ'
...
console.log(banner.string)
   ...
   qrcode.generate(qr, { small: true })
	...
	client.on('connecting', () => {
		start('2', 'Dwi Connecting...')
	})
	client.on('open', () => {
		success('2', 'Dwi Connected')
	})
...
*/
                ...
                addKoinUser('6285753213819@s.whatsapp.net', fee)
